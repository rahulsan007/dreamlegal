...
const FRAMEWORKS = [
  {
    value: "collaboration-editing",
    label: "Collaboration Ediiting",
    color: "#ef4444",
  },
  {
    value: "realttimechat",
  ...
  {
    value: "easedoccovertion",
    label: "Ease of Coverting",
    color: "#22c55e",
  },
] satisfies Framework[];
...
export function FeatureDocumentation({ onFrameworksChange }: any) {
  ...
  const createFramework = (name: string) => {
    ...
    onFrameworksChange([...selectedValues, newFramework]);
  };
  ...
  return (
    <div className="max-w-[350px]">
      <Popover open={openCombobox} onOpenChange={onComboboxOpenChange}>
        ...
        <PopoverContent className="w-[200px] p-0">
          <Command loop>
            <CommandInput
              ref={inputRef}
              placeholder="Search Deployements..."
              value={inputValue}
      ...
      <div className="relative -mb-24 mt-3 h-24 overflow-y-auto"></div>
    </div>
  );
}
