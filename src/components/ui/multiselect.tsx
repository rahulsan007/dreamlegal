...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "flex flex-wrap gap-1 p-1 py-2  rounded-lg bg-background",
        className
      )}
      {...props}
    >
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <CommandPrimitive.Input
      ...
      className={cn(
        "ml-2 bg-transparent border border-gray-300 shadow-sm  rounded-lg outline-none placeholder:text-muted-foreground flex-1",
        className,
