...
function NewProductAdminCard({ id, image, title, description }: any) {
  return (
    <div>
       <div>
      <div>
            ...
            <button
             ...
             View
              ...
              <button
                ...
                className=" flex gap-2 rounded-full bg-teal-500 text-white font-bold px-6 py-3 text-xs transition-all  w-fit items-center hover:bg-gray-900 hover:gap-4"
              >
               Approve
